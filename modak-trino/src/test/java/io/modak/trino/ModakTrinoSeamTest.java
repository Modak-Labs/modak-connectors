 ...
 * cold data, and Trino serves one consistent view through the modak catalog.
 */
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class ModakTrinoSeamTest {
    ...
    static void setUpWorld() throws Exception {
        ...
        runner.installPlugin(new ModakPlugin());
        runner.createCatalog("modak", "modak",
                Map.of("modak.jdbc-url", postgres.getJdbcUrl("postgres", "postgres")));
    }
    ...
    private static List<String> rows(String sql) {
        ...
        return result.getMaterializedRows().stream()
                .map(ModakTrinoSeamTest::formatRow)
                .sorted()
